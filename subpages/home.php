    ...
    <div class="terminal-content terminal-home-content">
        ...
        <div class="terminal-home-content-operations">
            <div class="terminal-home-content-operations-intro">
                ...
                <p class="terminal-text terminal-home-text">[ "jamesmellor.es/terminal" loaded</p>
                <p class="terminal-text terminal-home-text">[ Loading: "jamesmellor.es/about"...</p>
                <p class="terminal-text terminal-home-text">[ "jamesmellor.es/about" loaded</p>
                <p class="terminal-text terminal-home-text">[ Loading: "jamesmellor.es/portfolio"...</p>
                <p class="terminal-text terminal-home-text">[ "jamesmellor.es/portfolio" loaded</p>
                <p class="terminal-text terminal-home-text">[ Loading: "jamesmellor.es/contact"...</p>
                <p class="terminal-text terminal-home-text">[ "jamesmellor.es/contact" loaded</p>
                <p class="terminal-text terminal-home-text">[ Loading: "lights.js"...</p>
                <p class="terminal-text terminal-home-text">[ "lights.js" loaded</p>
